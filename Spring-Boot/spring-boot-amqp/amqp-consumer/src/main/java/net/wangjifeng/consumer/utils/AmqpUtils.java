package net.wangjifeng.consumer.utils;

import net.wangjifeng.consumer.entity.AmqpDef;
import net.wangjifeng.consumer.entity.ExchangeDef;
import net.wangjifeng.consumer.entity.QueueDef;
